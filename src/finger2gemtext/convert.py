...
##############################################################################
def _looks_like_user_list(finger_content: str) -> bool:
...
##############################################################################
def _convert_user_list_to_gemtext(finger_content: str) -> str:
...
def finger_to_gemtext(finger_content: str) -> str:
    ...
    """
    return (
        _convert_user_list_to_gemtext(finger_content)
        if _looks_like_user_list(finger_content)
        else finger_content
    )
